...
* [nadlan-mcp](https://github.com/nitzpo/nadlan-mcp) - MCP server for Israeli real estate data via Govmap API. ![GitHub last commit](https://img.shields.io/github/last-commit/nitzpo/nadlan-mcp?style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/nitzpo/nadlan-mcp?style=flat-square) ![GitHub stars](https://img.shields.io/github/stars/nitzpo/nadlan-mcp?style=flat-square)
