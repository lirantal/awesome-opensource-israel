...
* [datagov-mcp](https://github.com/aviveldan/datagov-mcp) - MCP server providing access to Israel's government public data platform (data.gov.il). ![GitHub last commit](https://img.shields.io/github/last-commit/aviveldan/datagov-mcp?style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/aviveldan/datagov-mcp?style=flat-square) ![GitHub stars](https://img.shields.io/github/stars/aviveldan/datagov-mcp?style=flat-square)
