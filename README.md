...
* [kivun-terminal](https://github.com/noambrand/kivun-terminal) - One-click Claude Code installer for Windows and macOS; bundles Node.js, Git, a Windows Terminal theme, a live status bar, and a folder picker with named profiles. ![GitHub last commit](https://img.shields.io/github/last-commit/noambrand/kivun-terminal?style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/noambrand/kivun-terminal?style=flat-square) ![GitHub stars](https://img.shields.io/github/stars/noambrand/kivun-terminal?style=flat-square)
...
* [kivun-terminal-wsl](https://github.com/noambrand/kivun-terminal-wsl) - A Claude Code terminal installer for RTL languages (Hebrew, Arabic, Persian and 8 more), with a BiDi wrapper for mixed RTL+LTR rendering; one-click WSL2 + Konsole installer on Windows and shell installers on Linux. ![GitHub last commit](https://img.shields.io/github/last-commit/noambrand/kivun-terminal-wsl?style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/noambrand/kivun-terminal-wsl?style=flat-square) ![GitHub stars](https://img.shields.io/github/stars/noambrand/kivun-terminal-wsl?style=flat-square)
