...
* WhatsNext [Server](https://github.com/AmosSzust/whatsnext-server) [Client](https://github.com/AmosSzust/whatsnext-client) - WhatsNext, connect through similar life events.
