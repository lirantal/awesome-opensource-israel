...
* [claude-2x-statusline](https://github.com/Nadav-Fux/claude-2x-statusline) - A minimal Israel-timezone status line for Claude Code showing when the 2X doubled-usage promotion is active. ![GitHub last commit](https://img.shields.io/github/last-commit/Nadav-Fux/claude-2x-statusline?style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/Nadav-Fux/claude-2x-statusline?style=flat-square) ![GitHub stars](https://img.shields.io/github/stars/Nadav-Fux/claude-2x-statusline?style=flat-square)
