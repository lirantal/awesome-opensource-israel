...
* [knesset-mcp](https://github.com/zohar/knesset-mcp) - MCP server for accessing Israeli parliament (Knesset) data. ![GitHub last commit](https://img.shields.io/github/last-commit/zohar/knesset-mcp?style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/zohar/knesset-mcp?style=flat-square) ![GitHub stars](https://img.shields.io/github/stars/zohar/knesset-mcp?style=flat-square)
