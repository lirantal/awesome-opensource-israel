...
* [no_human](https://github.com/no-human-ai/no_human) - Other coding agents try to write the code correctly. no_human proves the code it wrote is correct. ![GitHub last commit](https://img.shields.io/github/last-commit/no-human-ai/no_human?style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/no-human-ai/no_human?style=flat-square) ![GitHub stars](https://img.shields.io/github/stars/no-human-ai/no_human?style=flat-square)
